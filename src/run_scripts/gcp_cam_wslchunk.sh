...
bs=36                   # 15-20 for regular self-sup // 5 for carta // 36 for ViT
...
cp=/home/cache/cam
ldp="/home/lofi/lofi/src/outputs/train-"${dn}"-"${scenario}"-"${ps}"-"${filtration}"-labeldict.obj"
plp="/home/lofi/lofi/src/outputs/train-"${dn}"-"${scenario}"-"${ps}"-"${filtration}"-patchlist.obj"
mp=/home/lofi/lofi/models/cam
