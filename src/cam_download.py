...
def download_camelyon16_test_everyfewsec(savepath, seconds=60):
    for i in range(1,131):
        filename = "test_" + str(i).zfill(3) + ".tif"
        print("kicking off downloading:", filename)
...
if __name__ == "__main__":
    ...
    # savedir: /home/data/tinycam/test/raw_tifs
    ...
    if args.whichcam == "cam16":
        ...
        elif args.filename ==  "test_pinging": 
            download_camelyon16_test_everyfewsec(args.savedir)
        else:
